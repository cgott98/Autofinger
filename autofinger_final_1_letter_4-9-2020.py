        ...
        for line in parse:
            if line[:4] == "ATOM":
                ...
                if line[20:26] != value:
                    value = line[22:26]
                    residue = line[17:20]
                    residue_translator= ["ALA","ARG","ASN","ASP","CYS","GLU","GLN","GLY","HIS","ILE","LEU","LYS","MET","PHE","PRO","SER","THR","TRP","TYR","VAL"]
                    residue_1letter=["A","R","N","D","C","E","Q","G","H","I","L","K","M","F","P","S","T","W","Y","V"]
                    if residue in residue_translator:
                        one_letter_position = residue_translator.index(residue)
                        residue = residue_1letter[one_letter_position]
